...
describe('migration journal', () => {
  ...
  it('places gap-closure 0030 after 0029, BOQ 0032–0035 frozen, then overnight 0036–0045', async () => {
    ...
    expect(tags.indexOf('0077_billing_records_rls_boq_finalize')).toBeLessThan(
      tags.indexOf('0080_recurring_template_payment_occurrences'),
    );
    expect(tags.indexOf('0081_payment_instruments')).toBeLessThan(
      tags.indexOf('0082_billing_vat_repair_and_invariant'),
    );
    expect(tags.indexOf('0082_billing_vat_repair_and_invariant')).toBeLessThan(
      tags.indexOf('0083_payment_amount_basis'),
    );
    ...
    expect(tags.indexOf('0090_employee_app_global_username')).toBeLessThan(
      tags.indexOf('0091_employee_app_temp_pin_sealed'),
    );
    ...
    expect(tags.indexOf('0118_task_document_owner_access_correction')).toBeLessThan(
      tags.indexOf('0119_meetings_read_org_scope'),
    );
    expect(tags.indexOf('0119_meetings_read_org_scope')).toBeLessThan(
      tags.indexOf('0120_storage_documents_read_rls_and_member_folder_grants'),
    );
    ...
    expect(tags.indexOf('0125_ap_bill_inventory_layers_and_net_90_120')).toBeLessThan(
      tags.indexOf('0126_ap_bill_line_inventory_layers'),
    );
    ...
    expect(tags.indexOf('0128_project_context_null_safe')).toBeLessThan(
      tags.indexOf('0129_expense_cash_installment_schedule'),
    );
    expect(tags.at(-1)).toBe('0129_expense_cash_installment_schedule');
