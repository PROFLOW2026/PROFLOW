...
const ROUTE_CAPABILITY_PREFIXES: readonly {
  ...
  { prefix: '/operations', module: 'work_management' },
  { prefix: '/work', module: 'work_management' },
  { prefix: '/portfolio', module: 'work_management' },
  { prefix: '/workload', module: 'work_management' },
  { prefix: '/workspaces', module: 'work_management' },
  { prefix: '/meetings', module: 'work_management' },
