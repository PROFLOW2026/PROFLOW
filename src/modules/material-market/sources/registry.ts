...
export const SOURCE_SEED: SourceSeedRow[] = [
  ...
  },
  {
    ...
    sourceType: 'fred',
    sourceName: 'FRED',
    sourceSeriesId: FRED_SERIES.EUR_USD,
    sourceUrl: 'https://fred.stlouisfed.org/series/EXUSEU',
    frequency: 'monthly',
    unit: 'USD per EUR',
    currency: 'USD',
    isActive: true,
  ...
  },
  {
    ...
    sourceName: 'ProjectFlow',
    sourceSeriesId: null,
    sourceUrl: 'https://edge.boi.gov.il/FusionEdgeServer/sdmx/v2/data/dataflow/BOI.STATISTICS/EXR/1.0/RER_EUR_ILS',
    frequency: 'monthly',
    unit: 'ILS per EUR',
    currency: 'ILS',
    isActive: true,
