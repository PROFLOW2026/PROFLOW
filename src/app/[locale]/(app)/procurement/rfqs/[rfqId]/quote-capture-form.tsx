...
export function QuoteCaptureForm({
  ...
  return (
    ...
    <form
      action={formAction}
      className="flex w-full min-w-0 flex-col gap-4 rounded-lg border border-[var(--pf-border-default)] p-4"
    >
      ...
      <Field label={t('receivedOnLabel')} optionalLabel={tCommon('labels.optional')}>
        ...
        {(control) => <Input {...control} name="receivedOn" type="date" dir="ltr" />}
