                  ...
                  {rfqs.map((rfq) => (
                    <TableRow key={rfq.id}>
                      <TableCell className="font-medium">
                        <Link href={`/procurement/rfqs/${rfq.id}`} className="rounded-sm hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--pf-focus-ring)]">
                          {rfq.title}
                        </Link>
                      </TableCell>
                      <TableCell>
