...
import { employeeCreateClientAction } from '../actions';

export default async function EmployeeCreateClientPage() {
  const t = await getTranslations('employeeApp.clients.createForm');

  const allowed = await withOrgContext(async (context) => {
    await assertEmployeeAppContext(context);
    return employeeHasPermission(context, PERMISSIONS.CLIENTS_MANAGE);
  });
  ...
  return (
    <div className="space-y-4">
      ...
      <form action={employeeCreateClientAction} className="space-y-4">
