...
const MANAGER_PERMISSIONS: readonly PermissionKey[] = [
  ...
  PERMISSIONS.STAGES_MANAGE,
  PERMISSIONS.LABELS_MANAGE,
  PERMISSIONS.TASK_TEMPLATES_MANAGE,
  PERMISSIONS.PROJECT_TEMPLATES_MANAGE,
...
const FINANCE_PERMISSIONS: readonly PermissionKey[] = [
  ...
  PERMISSIONS.APPROVALS_DECIDE,
  PERMISSIONS.MONTH_CLOSE_READ,
  PERMISSIONS.MONTH_CLOSE_MANAGE,
  PERMISSIONS.BUDGETS_READ,
  PERMISSIONS.BUDGETS_MANAGE,
  PERMISSIONS.BOQ_READ,
  PERMISSIONS.BOQ_PROGRESS_APPROVE,
