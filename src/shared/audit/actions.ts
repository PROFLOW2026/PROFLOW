...
export const AUDIT_ACTIONS = {
  ...
  BILLING_PLAN_ACTIVATED: 'billing_plan.activated',
  BILLING_PLAN_COMPLETED: 'billing_plan.completed',
  BILLING_PLAN_ARCHIVED: 'billing_plan.archived',
  BILLING_PLAN_LINES_CHANGED: 'billing_plan.lines_changed',
  BILLING_PLAN_CYCLE_CREATED: 'billing_plan.cycle_created',
  BILLING_PLAN_CYCLE_UPDATED: 'billing_plan.cycle_updated',
  BILLING_PLAN_CYCLE_ISSUED: 'billing_plan.cycle_issued',
  BILLING_PLAN_CYCLE_VOIDED: 'billing_plan.cycle_voided',
  BILLING_PLAN_TEMPLATE_APPLIED: 'billing_plan.template_applied',
  BILLING_PLAN_TEMPLATE_SAVED: 'billing_plan.template_saved',
  ...
  TIME_ENTRY_EXCESS_APPROVED: 'time_entry.excess_approved',
  TIME_ENTRY_EXCESS_REJECTED: 'time_entry.excess_rejected',
  ...
  INVENTORY_COST_LAYER_BOOKED: 'inventory_cost_layer.booked',
  INVENTORY_COST_LAYER_UNBOOKED: 'inventory_cost_layer.unbooked',
  INVENTORY_COST_CONSUMED: 'inventory_cost.consumed',
